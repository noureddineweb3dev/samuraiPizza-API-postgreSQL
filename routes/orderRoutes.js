...
import { getOrder, createOrder, updateOrder, getAllOrders, deleteOrder, getMyOrders, getAdvancedStats } from '../controllers/orderController.js';
...
router.get('/stats', protect, restrictTo('admin', 'manager'), getAdvancedStats);
